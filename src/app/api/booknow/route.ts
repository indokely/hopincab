...
export async function POST(req: NextRequest) {
  try {
    ...
    const { name, email, mobile, transferType, pickupDate, pickupTime, pickupLocation, dropoffLocation, message } = body;
    ...
    await sheets.spreadsheets.values.append({
      ...
      requestBody: {
        values: [[name, email, mobile, transferType, pickupDate, pickupTime, pickupLocation, dropoffLocation, message]],
      },
    });
