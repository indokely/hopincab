...
const services: Service[] = [
  {
    ...
    description: 'Prompt and reliable airport transfers with professional drivers ensuring a smooth journey to or from New Zealand.',
    icon: <MapPinIcon className="h-10 w-10 text-blue-600" />
  },
  {
    title: 'Private Tours',
    description: 'Discover New Zealand with our tailored tours. Experience the best sights with our knowledgeable drivers.',
    icon: <ClockIcon className="h-10 w-10 text-blue-600" />
  },
  {
    title: 'Cab & Van Services',
    description: 'Spacious and comfortable cabs and vans for all your group transportation needs in New Zealand.',
  ...
  return (
    <PageLayout>
      ...
      <section className="relative flex flex-col items-center justify-center min-h-[70vh] bg-black text-white text-center px-4 pt-24 pb-16">
        <h1 className="text-4xl md:text-6xl font-extrabold mb-6 drop-shadow-lg">New Zealand Airport Transfers<br className="hidden md:inline" /> & City Rides, 24/7</h1>
        <p className="text-xl md:text-2xl max-w-2xl mx-auto mb-6 font-medium opacity-90">
          HopinCab makes getting to and from New Zealand fast, reliable, and affordable. Book a cab, van, or tour in seconds.
        </p>
        <div className="mb-8 bg-orange-500/10 border border-orange-500/30 px-6 py-2 rounded-full text-base font-semibold text-orange-400 inline-flex items-center gap-2">
        ...
        <div className="mt-8 flex flex-col items-center">
          <span className="uppercase text-xs tracking-widest text-gray-400 mb-4">Trusted by New Zealand travelers</span>
          <hr className="w-48 border-gray-700 mb-2" />
          <div className="flex flex-wrap justify-center gap-10">
            <a href="https://www.tripadvisor.in/Attraction_Review-g255118-d34217369-Reviews-HOPinCAB-Christchurch_Canterbury_Region_South_Island.html" target="_blank" rel="noopener noreferrer" title="TripAdvisor">
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-800 p-8 rounded-xl shadow hover:shadow-lg transition">
              ...
              <p className="text-gray-400">Prompt and reliable rides to and from New Zealand. Always on time, always comfortable.</p>
            </div>
            <div className="bg-gray-800 p-8 rounded-xl shadow hover:shadow-lg transition">
              <CalendarIcon className="h-10 w-10 text-white mb-4 mx-auto" />
              <h3 className="font-bold text-lg mb-2 text-white">Tours</h3>
              <p className="text-gray-400">Discover New Zealand with our tailored tours, guided by friendly, knowledgeable drivers.</p>
            </div>
            <div className="bg-gray-800 p-8 rounded-xl shadow hover:shadow-lg transition">
      ...
      <section className="py-12 bg-gray-800">
        <div className="container mx-auto px-4 max-w-3xl text-center">
          ...
          <p className="text-lg text-gray-400 mb-4">HopinCab is New Zealand&apos;s trusted airport transfer and tour provider. We deliver safe, reliable, and affordable rides—24/7, anywhere in the country.</p>
